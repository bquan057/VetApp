            ...
            <div className="hero is-centered is-fullheight">
                <div className="container">
                    <div className="buttons">
                        <button  className="button has-text-weight-bold has-text-primary-dark is-rounded is-fullwidth">Manage Users</button>
                        <button className= "button has-text-weight-bold has-text-primary-dark is-rounded is-fullwidth">Manage Animals</button>
                    </div>
