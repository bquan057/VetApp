...
const StudentCommentCard = (props) => {

    const animal = props.animal
    const newSCommentModal = props.newSCommentModal
                ...
                <div class="columns card is-multiline is-vcentered py-1">
                    {role==="Student"
                        ?<div className="column is-one-quarter has-text-centered">
                            <button className= "button has-text-weight-bold has-text-primary-dark is-rounded" onClick={newSCommentModal}>Create Comment</button>
                        </div>
                        :<div/>
                    }
                    <div className="column is-half has-text-centered">
                        <div className="title has-text-primary-dark has-text-weight-bold">Student Comments</div>
                    </div>
